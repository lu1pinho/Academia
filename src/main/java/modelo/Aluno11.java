...
public class Aluno11 {
    ...
    public Aluno11(String nome, String cpf, String nascimento, String email, String telefone, String plano){
    ...
    public Aluno11(String nome, String cpf, String nascimento, String email, String telefone, String plano, String status, String dataInicial, String dataFinal) {
        this.nome = nomeFormatter(nome);
        this.cpf = cpfFormatter(cpf);
        this.nascimento = nascimentoFormatter(nascimento);
        this.email = emailFormatter(email);
